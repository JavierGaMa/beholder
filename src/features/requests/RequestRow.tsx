...
export function RequestRow({
  ...
  return (
    <div
      ...
      onClick={onSelect}
      className={clsx(
        "flex cursor-default items-center gap-3 border-b border-line/50 px-3 font-mono text-[12px] leading-[34px]",
    ...
    >
      ...
      <span className="w-16 shrink-0 text-right">{formatMs(total)}</span>
